...
understanding of the song and various intricacies involved with replicating the guitar part.   
An existing technology that helps with this is audio stem-splitting which allows for isolation of different  
instruments without access to the multi-tracks of the song. While leading applications offering stem-splitting  
functionality can be valuable for practice and learning, most don't offer any kind of qualitative data on each  
song to build on the insight gained from instrument isolation, potentially leading to users missing key inferrences.  
